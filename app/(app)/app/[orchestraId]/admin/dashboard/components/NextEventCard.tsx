...
import SendReminderButton from "@/app/(app)/app/[orchestraId]/admin/dashboard/components/SendReminderButton";
import RSVPStatCard from "@/app/(app)/app/[orchestraId]/admin/dashboard/components/RSVPStatCard";
...
export default function NextEventCard({
    ...
    return (
      <Card>
        ...
        <div className="flex flex-col items-start gap-4 py-6">
          ...
          <Link href={`/app/${orchestraId}/admin/events/new`}>
  ...
  // ✅ FULLY SCOPED URLS
  const baseUrl = `/app/${orchestraId}/admin/events/${event.id}`;
  ...
  return (
    <Card>
      ...
      <div className="grid grid-cols-4 gap-3 mt-4">
        <RSVPStatCard label="Attending" value={counts.yes} color="green" />
        <RSVPStatCard label="Maybe" value={counts.maybe} color="yellow" />
        <RSVPStatCard label="Not Attending" value={counts.no} color="red" />
        <RSVPStatCard label="Pending" value={counts.pending} color="gray" />
      </div>
